...
INSERT INTO Employeee (FirstName, LastName, Department, HireDate, Salary) 
VALUES
...
INSERT INTO Customerss (CustomerName, City, Country) VALUES
...
CREATE TABLE Orderst(
    ...
    FOREIGN KEY(EmployeeID) REFERENCES Employeee(EmployeeID)
);
INSERT INTO Orderst (CustomerID, EmployeeID, OrderDate, Amount) VALUES
...
SELECT 
E.FirstName,
YEAR(O.OrderDate) AS YearOfEmployment
FROM orderst O
JOIN employeee E 
ON E.EmployeeID=O.EmployeeID;